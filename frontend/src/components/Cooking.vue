    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-actions>
            ...
            <v-btn
                    ...
                    color="deep-purple lighten-2"
                    text
                    @click="openAcceptOrRejeck"
            >
                AcceptOrRejeck
            </v-btn>
            <v-dialog v-model="acceptOrRejeckDiagram" width="500">
                <AcceptOrRejeckCommand
                        @closeDialog="closeAcceptOrRejeck"
                        @acceptOrRejeck="acceptOrRejeck"
                ></AcceptOrRejeckCommand>
            </v-dialog>
            <v-btn
                    v-if="!editMode"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async acceptOrRejeck(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['acceptor-rejeck'].href), params)
            ...
            openAcceptOrRejeck() {
                this.acceptOrRejeckDiagram = true;
            },
            closeAcceptOrRejeck() {
                this.acceptOrRejeckDiagram = false;
            },
            async start() {
                try {
                    if(!this.offline) {
